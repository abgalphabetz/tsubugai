 ...
 */
test.skip('test internal path length', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test bottom up order tree nodes', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test lisp like tree representation', () => fail("IMPLEMENT ME!!!"))