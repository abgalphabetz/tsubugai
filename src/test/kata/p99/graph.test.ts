 ...
 */
test.skip('test edge', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test path', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test cycle', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test s tree', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test ms tree', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test isomorphism', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test degree', () => fail("IMPLEMENT ME!!!"))
 ...
 */
test.skip('test depth first', () => fail("IMPLEMENT ME!!!"))

/*
 * P88 (**) Connected components (alternative solution)
 * Write a predicate that splits a graph into its connected components.
 */
test.skip('test connected components', () => fail("IMPLEMENT ME!!!"))

/*
 * P89 (**) Bipartite graphs
 * Write a predicate that finds out whether a given graph is bipartite.
 */
test.skip('test bipartite graphs', () => fail("IMPLEMENT ME!!!"))